...
export const metadata = {
  ...
  title: {
    default: "Musafir Pakistan — Northern Tours, Hotels & Transport",
    template: "%s | Musafir Pakistan"
  },
  description:
    "Tour operator offering weekly group departures to Hunza, Skardu, Swat & Kashmir from Karachi & Islamabad. Private 4x4 Prado honeymoon tours, verified hotel stays, and executive mountain transport.",
  keywords: [
    "Pakistan tours",
  ...
  openGraph: {
    ...
    description:
      "Tour operator. Weekly group departures to Hunza, Skardu, Swat & Kashmir. Private honeymoon tours, verified hotels, executive 4x4 transport.",
    images: [
      {
        url: "/images/hero.jpg",
        width: 1200,
  ...
  twitter: {
    ...
    title: "Musafir Pakistan — Northern Tours, Hotels & Transport",
    description:
      "Tour operator. Weekly group departures to Hunza, Skardu, Swat & Kashmir.",
  ...
  verification: {
    google: "HqsYVbQnYBShB8x7MkCWoJIyLD9sBYB4y32tkmY3wLA"
  }
};
...
const organizationJsonLd = {
  ...
  description:
    "Tour operator offering weekly group departures, private honeymoon tours, verified hotel bookings, and executive mountain transport across Northern Pakistan.",
...
const websiteJsonLd = {
  "@context": "https://schema.org",
  "@type": "WebSite",
  name: "Musafir Pakistan",
  url: SITE_URL,
  potentialAction: {
    "@type": "SearchAction",
    target: {
      "@type": "EntryPoint",
      urlTemplate: `${SITE_URL}/tours/group?q={search_term_string}`
    },
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="theme-color" content="#1a6d37" />
        <script
